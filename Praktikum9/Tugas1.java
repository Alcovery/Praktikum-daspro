...
public class Tugas1 {
    public static void main(String[] args) {
       ...
       System.out.println("-------------------"); 
       System.out.println("====== Menu kape ku =======");
       System.out.println("-------------------");
       ...
       String[] daftarMenu = {"Nasi Goreng", "Mie Goreng", "Roti Bakar", "Kentang Goreng", "Teh Tarik", "Cappucino", "Chocollate ice"};
       double[] daftarHarga = { 10000, 20000, 15000, 10000, 1200, 8000, 9000};
       ...
       while (true) {
        System.out.println("Masukkan nama menu (atau ketik 'selesai' untuk menyelesaikan pesanan): ");
        pilihMenu =sc22.nextLine();
        ...
        if (indeksMenu != -1) {
            System.out.println("Masukkan jumlah pesanan untuk " + pilihMenu + ": ");
            jumlahPesanan = sc22.nextInt();
            sc22.nextLine();
            ...
            System.out.println("Menu yang anda pilih tidak tersedia. Silahkan pilih menu kain.");
        }
       ...
       System.out.println("\n=== Terima Kasih Telah Berbelanja Di Kafe Cuek ====");
